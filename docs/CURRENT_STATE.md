...
홈 화면은 장문 소개형 구성을 정책 탐색 작업면으로 전환했다. 상단 검색·핵심지표, 좌측 분야·지역 필터, 중앙 정책 은하/정책 대장 전환, 우측 선택 정책·변화 스트림을 한 화면에 배치한다. 정책 은하는 자동 공전, 재생·정지와 배속, 드래그 회전, 휠·슬라이더 확대/축소, 노드 선택과 포커스 카드 연동을 지원한다.
